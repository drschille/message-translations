      ...
      <div className="mx-auto mt-2 w-full max-w-4xl border-t border-outline/20 px-8 py-12">
        <div className="flex items-center justify-between gap-8">
          <button onClick={onBack} className="group flex flex-col items-start gap-2 text-left">
            ...
            <span className="inline-flex items-center gap-2 font-headline text-xl text-on-surface">
              <ChevronLeft size={18} className="opacity-70" />
              Det ellevte bud
            </span>
          </button>

          <button onClick={onBack} className="group flex flex-col items-end gap-2 text-right">
      ...
      <footer className="border-t border-[#e5e2e1]/10 bg-[#1c1b1b] py-12">
        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 px-8 md:grid-cols-2 md:px-12">
          ...
          <div className="flex flex-wrap gap-6 md:justify-end">
            <a className="text-xs uppercase tracking-[0.08em] text-[#e5e2e1]/45 transition hover:text-[#e5e2e1]" href="#">
              Retningslinjer
            </a>
            <a className="text-xs uppercase tracking-[0.08em] text-[#e5e2e1]/45 transition hover:text-[#e5e2e1]" href="#">
              Personvern
